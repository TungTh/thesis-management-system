...
export function Comment(props: { testId: string; comments: any[] }) {
  ...
  const handleCreateComment = () => {
    createComment({
      ...
      .catch((error) => {
        setError(
          "Hey please, don't spam. We don't have the money to buy more storage for our database."
        );
      });
  };
                ...
                <React.Fragment>
                  ...
                  >
                    ...
                    {(authorization.user.role.name.toLowerCase() === "admin" ||
                      authorization.user.role.name.toLowerCase() ===
                        "moderator" ||
